...
![Atelier 오픈월드 오피스 — 9개 부서 방 + 하단 Cross-Dept Council 홀, 내 캐릭터가 WASD/방향키로 전체 맵을 걸어다니고 카메라가 따라갑니다](docs/r40-office.png)
...
| `/office` — 오픈월드 오피스 (WASD/방향키로 이동) | ![](docs/r40-office.png) |
| `/dashboard` — 실행 요약 | ![](docs/r40-dashboard.png) |
